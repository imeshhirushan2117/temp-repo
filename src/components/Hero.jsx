    ...
    <section className="relative bg-hero bg-cover bg-center bg-no-repeat h-screen w-full">
      <div className="max_padd_container relative top-32 xs:top-52">
        ...
        <p className="text-gray-50 regular-16 mt-6 max-w-[33rem]">
          ...
          mollitia laboriosam? Odit totam illum, asperiores, ipsum dignissimos
          earum velit rerum quisquam debitis architecto quia, rem odio sint
          nesciunt sit commodi ex vitae. Nostrum.
        </p>
        ...
        <div className="flexStart !items-center gap-x-4 my-10">
          ...
          <div className="blod-16 sm:bold-20">
            176K{" "}
